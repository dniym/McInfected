...
public class Equip {
	...
	public static void equip(Player p) {
		...
		// Reset their inventory by: Going through and removing any old items from the class
		...
		//Only replace the armor if the player hasn't changed it(So if it there is none, or if it is the same as default)
