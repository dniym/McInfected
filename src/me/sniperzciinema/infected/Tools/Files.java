...
public class Files {
	...
	public static void reloadArenas() {
		if (Files.arenasFile == null)
			Files.arenasFile = new File(Bukkit.getPluginManager().getPlugin("Infected").getDataFolder(),
					"Arenas.yml");
	...
	public static void reloadClasses() {
		if (Files.classesFile == null)
			Files.classesFile = new File(Bukkit.getPluginManager().getPlugin("Infected").getDataFolder(),
					"Classes.yml");
	...
	public static void reloadPlayers() {
		if (Files.playerFile == null)
			Files.playerFile = new File(Bukkit.getPluginManager().getPlugin("Infected").getDataFolder(),
					"Players.yml");
	...
	public static void reloadShop() {
		if (Files.shop == null)
			Files.shopFile = new File(Bukkit.getPluginManager().getPlugin("Infected").getDataFolder(),
					"Shop.yml");
	...
	public static void reloadSigns() {
		if (Files.signsFile == null)
			Files.signsFile = new File(Bukkit.getPluginManager().getPlugin("Infected").getDataFolder(),
					"Signs.yml");
