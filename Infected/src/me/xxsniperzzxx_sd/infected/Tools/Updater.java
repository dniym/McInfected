...
public class Updater
{
    ...
    public String updateBukkitVersion; // Gets the updated plugin's bukkit version
    ...
    private void saveFile(File folder, String file, String u)
    {
        ...
        try
        {
            // Download the file
            URL url = new URL(u);
            int fileLength = url.openConnection().getContentLength(); in = new BufferedInputStream(url.openStream());
    ...
    private String getFile(String link)
    {
        ...
        try
        {
            ...
            while ((line = buff.readLine()) != null)
            {
                ...
                } // Search for the Bukkit Version
                if (line.contains("<dd><ul class=\"comma-separated-list\"><li>CB"))
                {
